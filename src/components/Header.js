  ...
  render() {
    const Header = styled.div`
      ...
      @media (max-width: 600px) {
        background-image: url(https://raw.githubusercontent.com/CarlinGebyte/Reto-1-Sprint-2-AG/499ba5fae3f7afbcd3c23182d0c0ee6450b4c562/src/img/bg-header-mobile.svg);
      }
    `;
    return (
      <Header/>
